...
description: >
  ...
  budget-aware reassembly. Use when configuring compaction specs, switching
  work modes, understanding extraction strategies, authoring custom extracts,
  or debugging compaction budget and artifact growth.
---
